...
<html lang="en">
    ...
    <head>
        ...
        {{--  <link  href="{{ asset('assetsss/css/light.css') }}" rel="stylesheet">  --}}
    ...
    <body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
        ...
        <script src="{{ asset('assetsss/js/jquery.validate.min.js')}}"></script>
        
        <script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
        <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
        <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />
        @if (isset($table) && $table == "yes")
        <script type="text/javascript" src="{{asset('assetsss/plugins/datatable/js/jquery.dataTables.min.js')}}"></script>
