@extends('layouts.app')
@section('title', "Upi Fund Pending Request")
@section('pagetitle',  "Upi Fund Pending Request")
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Upi Fund Pending Request</h4>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('statement/fetch')}}/upifundrequestview/0";
        var onDraw = function() {};
        var options = [
            { "data" : "name",
