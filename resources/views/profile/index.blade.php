            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="profile-sidebar text-center shadow-sm">
                        <img src="{{ asset('assets/img/a.png') }}" style="width:40%;" alt="User">
                                ...
                                <form>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ Auth::user()->kyc }}" readonly>
                                        </div>
                                    </div>
                                    @if (Myhelper::hasRole('admin'))
                            ...
                            <div id="kyc">
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ Auth::user()->aadharcard }}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">PAN Number</label>
                                        <input type="text" class="form-control" value="{{ Auth::user()->pancard }}">
                                    </div>
                                    @if (Myhelper::hasRole('admin'))
                            ...
                            <div id="role">
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" value="{{ Auth::user()->role_id }}" readonly>
                                    </div>
