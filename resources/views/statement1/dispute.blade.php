        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">UPI Statement</h4>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('statement/fetch')}}/dispute/{{$id}}";
        var onDraw = function() {
        };
        var options = [
            { "data" : "name",
            ...
            { "data" : "bank",
                render:function(data, type, full, meta){
                    return `payer_vpa - `+full.option2+`<br>Mobile - `+full.option4+`<br>Name - `+full.option3;
                }
            },
            { "data" : "bank",
                render:function(data, type, full, meta){
            ...
            { "data" : "bank",
                render:function(data, type, full, meta){
                        ...
                        return `Ref No. - `+full.refno+`<br>Txnid - `+full.txnid+`<br>Client Id - `+full.mytxnid+`<br>NPCI Id - `+full.refno+`<br>Bank Id - `+full.payid;
           ...
           { "data" : "bank",
            ...
            { "data" : "status",
                render:function(data, type, full, meta){
                    ...
                    menu += `<li class="dropdown-header">Charge Back</li>
                            <li><a href="javascript:void(0)" onclick="chargeBackUpdate(`+full.id+`, 'chargeBackUpdate')"><i class="icon-info22"></i>Raise Charge Back</a></li>`;
                    @endif
                    ...
                    menu += `<li class="dropdown-header">Resend Callback</li>
                            <li><a href="javascript:void(0)" onclick="resendCallback(`+full.id+`, 'callbackresend')"><i class="icon-info22"></i>Resend Callback</a></li>`;  
