        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Pending UPI Statement</h4>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('statement/fetch')}}/pendingupistatement/{{$id}}";
        var onDraw = function() {
        };
        var options = [
            { "data" : "name",
            ...
            { "data" : "bank",
                render:function(data, type, full, meta){
                    return `payer_vpa - `+full.payer_vpa+`<br>Mobile - `+full.payerMobile+`<br>Name - `+full.payerAccName+`<br>IFSC - `+full.payerIFSC;
                }
            },
            { "data" : "bank",
                render:function(data, type, full, meta){
    ...
    function viewUtiid(id){
        $.ajax({
            url: `{{url('statement/fetch')}}/pendingupistatement/`+id,
            type: 'post',
            headers: {
