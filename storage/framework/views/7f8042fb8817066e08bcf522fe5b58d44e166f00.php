  <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="authentication-signin.html"><i class="bi bi-arrow-right-short"></i>Sign In</a>
                </li>
                <li> <a href="authentication-signup.html"><i class="bi bi-arrow-right-short"></i>Sign Up</a>
                </li>
                ...
                <li> <a href="authentication-forgot-password.html"><i class="bi bi-arrow-right-short"></i>Forgot Password</a>
                </li>
                <li> <a href="authentication-reset-password.html"><i class="bi bi-arrow-right-short"></i>Reset Password</a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li> <a href="pages-blank-page.html"><i class="bi bi-arrow-right-short"></i>Blank Page</a>
                </li>
              </ul>
            </li>
            <li>
...
<?php /**PATH C:\wamp64\www\pg\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>