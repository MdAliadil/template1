                  ...
                  <div class="card-body">
                      <div class="d-flex align-items-center">
                          <div>
                              ...
                              <h4 class="my-1">₹ <?php echo e(Auth::user()->upiwallet); ?></h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <h4 class="my-1">₹ <?php echo e(Auth::user()->mainwallet); ?></h4>
                  ...
                  <div class="card-body">
                      <div class="d-flex align-items-center">
                          <div>
                              ...
                              <h4 class="my-1">₹ <?php echo e(Auth::user()->disputewallet); ?></h4>
                        ...
                        <ul class="list-group list-group-flush mt-3">
                          ...
                          <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                              ...
                              <div class="ms-auto"><span id="lastMonthPayinAmount" class="fw-bold">₹0</span></div>
                           </div>
                         </li>
                         <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                         ...
                         <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                              ...
                              <div class="ms-auto"><span id="thisMonthPayinTxn" class="fw-bold">0</span></div>
                           </div>
                         </li>
                         <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                              ...
                              <div class="ms-auto"><span id="lastMonthPayinTxn" class="fw-bold">0</span></div>
                           </div>
                         </li>
                        ...
                        <p class="mb-0 text-secondary font-13">Our Most Customers in India</p>
                         <ul class="list-group list-group-flush mt-3">
                          ...
                          <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                              <div></div>
                              <div>This Month’s Amount</div>
                              <div class="ms-auto"> <span id="thisMonthPayoutAmount" class="fw-bold">₹0</span>                           </div>
                         </li>
                         <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                              <div></div>
                              <div> Last Month’s Amount</div>
                              <div class="ms-auto"><span id="lastMonthPayoutAmount" class="fw-bold">₹0</span></div>
                           </div>
                         </li>
                         <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                         ...
                         <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                              <div></div>
                              <div>This Month’s Transactions </div>
                              <div class="ms-auto"><span id="thisMonthPayoutTxn" class="fw-bold">0</span></div>
                           </div>
                         </li>
                         <li class="list-group-item">
                           <div class="d-flex align-items-center gap-2">
                              <div></div>
                              <div>Last Month’s Transactions</div>
                              <div class="ms-auto"><span id="lastMonthPayoutTxn" class="fw-bold">0</span></div>
                           </div>
                         </li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\template\resources\views/dashboard/home.blade.php ENDPATH**/ ?>