     ...
     <main class="page-content">
         ...
         <div class="d-flex align-items-center mb-3">
            <a href="<?php echo e(route('home')); ?>"> <span class="me-1 mb-1 h3 card-title d-inline-block">Home</span></a>
             ...
             <span class="h3 ms-2 card-title">Payin</span>
           </div>
         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between pb-0">
                <h4 class="mb-0 text-muted text-uppercase" >Payin Wallet</h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\template1\resources\views/statement/account.blade.php ENDPATH**/ ?>