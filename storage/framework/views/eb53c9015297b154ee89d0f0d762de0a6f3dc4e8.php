                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="status" class="form-select border-0 shadow-sm">
                            <option value=""  style="color:black;">Select <?php echo e($status['type'] ?? ''); ?> Status</option>
...
<?php /**PATH C:\wamp64\www\template\resources\views/layouts/filter.blade.php ENDPATH**/ ?>