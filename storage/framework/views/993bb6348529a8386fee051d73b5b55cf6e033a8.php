                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-money" style="color:black;"></i></i></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page" style="color:black">Payout Statement</li>
                            </ol>
                        </nav>
                    </div>
       ...
       <?php echo $__env->make('layouts.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
                ...
                <div class="card">
                    <div class="card-header">
                        <h6 class="mb-0 text-uppercase" style="color:black;" >Payout Statement</h6>
                    </div>
                    <div class="card-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\template\resources\views/statement/payout.blade.php ENDPATH**/ ?>