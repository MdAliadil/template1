...
class Idfcreport extends Model
{
    use LogsActivity;

    protected $fillable = ['number','mobile','provider_id','api_id','amount','charge','profit','gst','bank','mytxnid','terminalid','authcode','type','transtype','TxnMedium','credited_by','aepstype','payeeVPA','payer_vpa','payerMobile','payerAccName','payerIFSC','aadhar','tds','apitxnid','txnid','payid','refno','description','remark','option1','option2','option3','option4','status','user_id','credit_by','rtype','via','adminprofit','balance','trans_type','product','wid','wprofit','mdid','mdprofit','disid','disprofit','oid','oprofit','chargebackamt','chargebackOrdId'];
